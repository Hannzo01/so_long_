...
// 	mlx_put_image_to_window(game->mlx, game->mlx_window, game->player_image, 0,
// 		0);
// 	mlx_put_image_to_window(game->mlx, game->mlx_window, game->door_image, 51,
// 		51);
// 	mlx_put_image_to_window(game->mlx, game->mlx_window, game->floor_image, 100,
// 		100);
// 	mlx_put_image_to_window(game->mlx, game->mlx_window,
// 		game->collectible_image, 200, 200);
// 	mlx_put_image_to_window(game->mlx, game->mlx_window, game->wall_image, 0,
// 		0);
// 	return (0);
// }
...
// 			"./textures/player.xpm", &game->image_width, &game->image_height);
// 	game->door_image = mlx_xpm_file_to_image(game->mlx, "./textures/door.xpm",
...
// 			&game->image_height);
// 	game->wall_image = mlx_xpm_file_to_image(game->mlx, "./textures/wall.xpm",
// 			&game->image_width, &game->image_height);
// 	game->floor_image = mlx_xpm_file_to_image(game->mlx, "./textures/floor.xpm",
// 			&game->image_width, &game->image_height);
